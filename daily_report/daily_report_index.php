                            ...
                            <form method="post" id="daily_report_form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="input-group mb-3" id="div_name">
                                            <span id="div_name" class="input-group-text">Name</span>
                                            <input type="text" disabled class="form-control" id="name" name="name" placeholder="name" value="<?php if ($_GET["method"] == "add") {
                                                                                                                                                                                                    echo "";
                                        ...
                                        <div class="input-group mb-3" id="div_num_year"><span id="div_span_num_year"   class="input-group-text">num_year</span><input disabled type="number" class="form-control" placeholder="num_year" id="num_year" name="num_year" value="<?php if ($_GET["method"] == "add") {
                                                                                                                                                                                                                                                                                                                                    echo "";
                                                                                                                                                                                                                                                                                                                                } else if ($_GET["method"] == "edit") {
                                        ...
                                        <div class="input-group mb-3" id="div_num_month"><span id="div_span_num_month"   class="input-group-text">num_month</span><input disabled type="number" class="form-control" placeholder="num_month" id="num_month" name="num_month" value="<?php if ($_GET["method"] == "add") {
                                                                                                                                                                                                                                                                                                                                        echo "";
                                                                                                                                                                                                                                                                                                                                    } else if ($_GET["method"] == "edit") {
                                        ...
                                        <div class="input-group mb-3" id="div_num_week"><span id="div_span_num_week"   class="input-group-text">num_week</span><input disabled type="number" class="form-control" placeholder="num_week" id="num_week" name="num_week" value="<?php if ($_GET["method"] == "add") {
                                                                                                                                                                                                                                                                                                                                    echo "";
                                                                                                                                                                                                                                                                                                                                } else if ($_GET["method"] == "edit") {
